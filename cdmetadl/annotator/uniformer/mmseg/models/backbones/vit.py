...
from cdmetadl.annotator.uniformer.mmcv.cnn import (Conv2d, Linear, build_activation_layer, build_norm_layer,
                      constant_init, kaiming_init, normal_init)
from cdmetadl.annotator.uniformer.mmcv.runner import _load_checkpoint
